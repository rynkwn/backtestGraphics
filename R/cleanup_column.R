...
cleanup_column <- function(x,
  ...
  message(paste0("cleanup_column with parameters: \n", 
                 ...
                 "id.var: ", head(id.var), "\n",
                 "date.var: ", head(date.var), "\n",
                 "nmv.var: ", head(nmv.var), "\n",
                 "gmv.var: ", head(gmv.var), "\n",
                 "pnl.var: ", head(pnl.var), "\n",
                 "contract.var: ", head(contract.var), "\n",
                 "sector.var: ", head(sector.var), "\n",
                 "strategy.var: ", head(strategy.var), "\n",
                 "substrategy.var: ", head(substrategy.var), "\n",
                 "portfolio.var: ", head(portfolio.var), "\n\n"
                 ))
